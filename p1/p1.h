...
struct strstr {
        // declare a pointer  to the char array that contains the sequences of character
        char *ptr;
        // declare variable that holds the length (the capacity) of that array
        int str_capacity;
        // declare a variable that holds the length of the actual string contained in the array
        int str_len;
};
